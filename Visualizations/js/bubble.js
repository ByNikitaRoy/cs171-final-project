...
class BubbleViz {
    ...
    control() {
        ...
        // progressEnter.append("div").attr("class", "slider-label");
        ...
        // progressUpdate
        //   .select(".slider-label")
        //   .text(d3.timeFormat("%d %b. %Y")(this.data[this.timeIndexSelected].date));
        ...
        dateLabelEnter.attr("x", -innerWidth / 2).attr("y", -innerHeight / 2 + 60);

        dateLabelUpdate.text(
            d3.timeFormat("%d %b. %Y")(this.data[this.timeIndexSelected].date)
        );
    }
